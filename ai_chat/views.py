...
class ChatSessionViewSet(viewsets.ModelViewSet):
    ...
    def send_message(self, request, pk=None):
        ...
        if serializer.is_valid():
            ...
            if stream:
                ...
                # Regular response
                try:
                    result = async_to_sync(chat_service.send_message)(
    ...
    def deactivate(self, request, pk=None):
        ...
        session.save()
        return Response(
            {"message": "Chat session deactivated"}, status=status.HTTP_200_OK
        )
...
class LLMModelViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def sync_models(self, request):
        ...
        try:
            ...
            return Response(
                {"message": "Models synced successfully", "models": serializer.data}
            )
        except Exception as e:
...
class MCPToolsViewSet(viewsets.ViewSet):
    """ViewSet for MCP (Model Context Protocol) tools"""
    ...
    def list_tools(self, request):
        ...
        try:
            ...
            return Response({"tools": tools_schema, "count": len(tools_schema)})
        except Exception as e:
    ...
    def execute_tool(self, request):
        ...
        try:
            ...
            result = async_to_sync(mcp_server.execute_tool)(tool_name, arguments)
    ...
    # Individual tool endpoints for convenience

    @action(detail=False, methods=["get"])
    def list_layers(self, request):
        """List all available geospatial layers"""
        try:
            result = async_to_sync(mcp_server.execute_tool)("list_layers", {})
            return Response(result)
        except Exception as e:
    ...
    @action(detail=False, methods=["post"])
    def find_layer_by_name(self, request):
        """Find a layer by name"""
        try:
            layer_name = request.data.get("layer_name")
            if not layer_name:
                return Response(
                    {"error": "layer_name is required"},
                    status=status.HTTP_400_BAD_REQUEST,
                )

            result = async_to_sync(mcp_server.execute_tool)(
                "find_layer_by_name", {"layer_name": layer_name}
            )
            return Response(result)
        except Exception as e:
            logger.error(f"Error finding layer: {str(e)}")
            return Response(
                {"error": str(e), "success": False},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    @action(detail=False, methods=["post"])
    def get_layer_info(self, request):
        ...
        try:
            ...
            if not layer_id and not layer_name:
                return Response(
                    {"error": "Either layer_id or layer_name is required"},
                    status=status.HTTP_400_BAD_REQUEST,
                )
            ...
            result = async_to_sync(mcp_server.execute_tool)("get_layer_info", args)
            return Response(result)
        except Exception as e:
    ...
    @action(detail=False, methods=["post"])
    def analyze_population(self, request):
        """Analyze population data in a layer"""
        try:
            required_fields = ["population_field"]
            ...
            result = async_to_sync(mcp_server.execute_tool)(
                "analyze_population", request.data
            )
            return Response(result)
        except Exception as e:
    ...
    @action(detail=False, methods=["post"])
    def get_attribute_stats(self, request):
        """Get attribute statistics"""
        try:
            attribute_key = request.data.get("attribute_key")
            if not attribute_key:
                return Response(
                    {"error": "attribute_key is required"},
                    status=status.HTTP_400_BAD_REQUEST,
                )

            result = async_to_sync(mcp_server.execute_tool)(
                "get_attribute_stats", request.data
            )
            return Response(result)
        except Exception as e:
    ...
    @action(detail=False, methods=["post"])
    def analyze_layer_attributes(self, request):
        """Perform comprehensive layer attribute analysis"""
        try:
            result = async_to_sync(mcp_server.execute_tool)(
                "analyze_layer_attributes", request.data
            )
            return Response(result)
        except Exception as e:
            logger.error(f"Error analyzing layer attributes: {str(e)}")
            return Response(
                {"error": str(e), "success": False},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR,
            )
    ...
    def web_search(self, request):
        ...
        try:
            ...
            result = async_to_sync(mcp_server.execute_tool)("web_search", request.data)
            return Response(result)
        except Exception as e:
